class BackingTab {
    ...
    static curData = null;
    constructor() {
        // BackingTab.curData = null;
    }

    static build() {
        BackingTab.viewer.init(1000, 105, 0, 1, 40, 3, 0.55, 0.6);

        BackingTab.backingTree = new BackingTree();

        BackingTab.backingTree.buildList();

        BackingTab.buildCombobox();
        BackingTab.buildTable();
        BackingTab.initCommandEvent();

        BackingTab.curData = BackingTab.getDefaultJson();
        // ラインを1つ追加
...
// const backingTab = new BackingTab();